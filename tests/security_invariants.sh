...
echo "CHECK announcement service"; contains "$announcement" 'active' 'announcement service must filter active records'
contains "$announcement" 'app_versions' 'announcements must support app-version targeting'
echo "CHECK announcement display type contract"; contains "$announcementAdmin" 'display_type' 'announcement admin must persist numeric app-owned display type'
