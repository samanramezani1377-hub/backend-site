...
contains "$versionAdmin" 'version_compare\(\$minimum[[:space:]]*,[[:space:]]*\$latest' 'minimum supported version must not exceed latest version'
contains "$versionAdmin" 'version_compare\(\$recommended[[:space:]]*,[[:space:]]*\$latest' 'recommended version must not exceed latest version'
contains "$versionAdmin" 'version_compare\(\$recommended[[:space:]]*,[[:space:]]*\$minimum' 'recommended version must not be below minimum supported version'
