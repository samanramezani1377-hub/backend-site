...
function woogit_render_theme_management() {
    ...
    $features = array_map(function($item){ $item['enabled'] = array_key_exists('enabled',$item) ? $item['enabled'] : true; return $item; }, woogit_theme_items('features_json', woogit_default_content('features')));
    $steps = array_map(function($item){ $item['enabled'] = array_key_exists('enabled',$item) ? $item['enabled'] : true; return $item; }, woogit_theme_items('steps_json', woogit_default_content('steps')));
    $faq = array_map(function($item){ $item['enabled'] = array_key_exists('enabled',$item) ? $item['enabled'] : true; return $item; }, woogit_theme_items('faq_json', woogit_default_content('faq')));
