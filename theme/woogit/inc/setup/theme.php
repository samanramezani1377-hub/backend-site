...
function woogit_enqueue_assets(){
  ...
  wp_enqueue_style('woogit-polish',WOOGIT_THEME_URI.'/assets/css/theme-polish.css',['woogit-responsive'],woogit_asset_version('/assets/css/theme-polish.css'));
  ...
  wp_localize_script('woogit-core','WooGitTheme',[
    'restUrl'=>esc_url_raw(rest_url('woogit/v1/')),'nonce'=>wp_create_nonce('wp_rest'),'authAjax'=>admin_url('admin-ajax.php'),
    'authNonce'=>wp_create_nonce('woogit_web_auth'),'portalNonce'=>wp_create_nonce('woogit_portal'),'home'=>home_url('/'),
    'loginUrl'=>woogit_page_url('login'),'portalUrl'=>woogit_page_url('portal')
  ]);
}
function woogit_print_head_meta(){echo '<meta name="theme-color" content="var(--bg)">';}
