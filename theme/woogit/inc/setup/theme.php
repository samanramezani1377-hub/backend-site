...
function woogit_enqueue_assets() {
  ...
  if(in_array($slug,['login','register'],true)) {
    wp_enqueue_script('woogit-auth',WOOGIT_THEME_URI.'/assets/js/auth.js',['woogit-core'],woogit_asset_version('/assets/js/auth.js'),true);
  }
  if(woogit_is_portal()) {
    wp_enqueue_script('woogit-portal',WOOGIT_THEME_URI.'/assets/js/portal.js',['woogit-core'],woogit_asset_version('/assets/js/portal.js'),true);
  }
