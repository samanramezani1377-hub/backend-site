...
<section class="wg-section wg-container" aria-labelledby="wg-doc-title">
  ...
  <div class="wg-actions"><a class="wg-btn wg-btn--primary" href="<?php echo esc_url(woogit_page_url('download')); ?>">نصب اپ WooGit</a><a class="wg-btn wg-btn--ghost" href="<?php echo esc_url(woogit_page_url('features')); ?>">مشاهده همه امکانات</a></div>
</section>
