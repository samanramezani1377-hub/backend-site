...
<?php foreach($items as $item): if(!is_array($item))continue; $question=wp_strip_all_tags((string)($item['question']??''));$answer=wp_kses_post((string)($item['answer']??''));if(!$question||!$answer)continue; ?><details class="wg-card wg-faq__item"><summary><?php echo esc_html($question); ?><span aria-hidden="true">+</span></summary><div class="wg-faq__answer"><?php echo $answer; ?></div></details><?php endforeach; ?></div><div class="wg-actions"><a class="wg-btn wg-btn--primary" href="<?php echo esc_url(woogit_page_url('download')); ?>">نصب اپ WooGit</a><a class="wg-btn wg-btn--ghost" href="<?php echo esc_url(woogit_page_url('documentation')); ?>">راهنمای کامل</a></div></section>
