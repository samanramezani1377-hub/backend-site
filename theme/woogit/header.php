...
<?php if($portal): ?><button class="wg-btn wg-btn--ghost" type="button" data-woogit-logout>خروج</button><?php else: ?><a class="wg-btn wg-btn--ghost" href="<?php echo esc_url(woogit_page_url('login')); ?>">ورود</a><a class="wg-btn" href="<?php echo esc_url(woogit_page_url('register')); ?>">شروع با WooGit</a><?php endif; ?>
