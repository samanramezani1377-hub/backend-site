...
final class Database
{
    public static function install(string $fromVersion = ''): void
    {
        ...
        dbDelta("CREATE TABLE {$prefix}bazaar_purchases (id BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,account_id BIGINT UNSIGNED NOT NULL,site_id BIGINT UNSIGNED NOT NULL,product_id VARCHAR(190) NOT NULL,purchase_token VARCHAR(255) NOT NULL,order_id VARCHAR(190) NULL,purchase_time DATETIME NOT NULL,expires_at DATETIME NOT NULL,verified_at DATETIME NOT NULL,PRIMARY KEY (id),UNIQUE KEY purchase_token (purchase_token),KEY account_site (account_id,site_id),KEY expires_at (expires_at)) {$charset};");
