...
final class RestController
{
    ...
    public function forward(\WP_REST_Request $request): \WP_REST_Response
    {
        ...
        $resource=sanitize_key((string)$request->get_param('resource'));$rawId=$request->get_param('id');$id=($rawId===null||$rawId==='')?null:absint($rawId);$path=$this->policy->resolve($resource,$id);if($path===null)return new \WP_REST_Response(['code'=>'operation_not_allowed'],404);
