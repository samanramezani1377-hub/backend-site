...
add_action('admin_menu',static function():void{(new \WooGit\Backend\AccountsAdmin())->register();(new \WooGit\Backend\LifecycleAdmin())->register();(new \WooGit\Backend\VersionAdmin())->register();(new \WooGit\Backend\AnnouncementAdmin())->register();});
