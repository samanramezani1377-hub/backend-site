...
define('WOOGIT_BACKEND_VERSION','0.2.1');
define('WOOGIT_BACKEND_FILE',__FILE__);
define('WOOGIT_BACKEND_DIR',plugin_dir_path(__FILE__));

foreach(['Database','AccountService','SiteService','EntitlementService','SessionService','IdempotencyService','ProxyPolicy','WooCommerceProxy','RestController'] as $file) require_once WOOGIT_BACKEND_DIR.'src/'.$file.'.php';
