...
define('WOOGIT_BACKEND_VERSION','0.3.6');
...
add_action('woogit_backend_cleanup',static function():void{
    ...
    $wpdb->query($wpdb->prepare("DELETE FROM {$wpdb->prefix}woogit_web_sessions WHERE expires_at < %s",$now));
...
add_action('rest_api_init',static function():void{
    ...
    (new \WooGit\Backend\WebAuthController())->register();
});